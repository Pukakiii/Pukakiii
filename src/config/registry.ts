 ...
 * @example "@pukakiii" - Users can install components with: `npx shadcn add @placeholder/wheel-picker`
 * @see https://ui.shadcn.com/docs/registry/namespace#overview
 */
 namespace: process.env.NEXT_PUBLIC_REGISTRY_NAMESPACE || "@pukakiii",
 /**
 * URL pattern for resolving namespaced components
 * The {name} placeholder will be replaced with the component name
 * @example "https://placeholder.local/r/{name}.json" resolves to "https://placeholder.local/r/wheel-picker.json"
 ...
 */
 ...
 "https://placeholder.local/r/{name}.json",
}
