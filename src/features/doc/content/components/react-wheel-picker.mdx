...
image: /placeholder-assets/images/blog/react-wheel-picker.webp?t=1747747932
...
<ComponentPreview
 ...
 openInV0Url="https://placeholder.local/r/wheel-picker.json"
/>
...
<DocTestimonial
 ...
 quote="See @pukakiii Wheel Picker. It’s on the registry. Quick install."
 date="2026-05-22"
/>

## Features

Built on top of [React Wheel Picker](https://react-wheel-picker.placeholder.local) – Backed by ▲Vercel OSS Program.
...
```bash
npx shadcn@latest add @placeholder/wheel-picker
```
...
```bash
npm install @react-wheel-picker clsx tailwind-merge
```
...
See the [React Wheel Picker](https://react-wheel-picker.placeholder.local/docs/getting-started) documentation for more information.
