...
image: /placeholder-assets/images/blog/share-menu.webp
new: true
...
<ComponentPreview
 ...
 openInV0Url="https://placeholder.local/r/share-menu.json"
/>
...
```bash
npx shadcn@latest add @placeholder/share-menu
```
...
```tsx
<ShareMenu title="placeholder.local" url="https://placeholder.local" />
```
