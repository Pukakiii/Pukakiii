...
image: /placeholder-assets/images/blog/shimmering-text.webp
...
<ComponentPreview
 ...
 openInV0Url="https://placeholder.local/r/shimmering-text.json"
...
<DocTestimonial
 ...
 quote="Using an adapted version of your Shimmer here @pukakiii"
 date="2026-06-01"
/>
...
```bash
npx shadcn@latest add @placeholder/shimmering-text
```
