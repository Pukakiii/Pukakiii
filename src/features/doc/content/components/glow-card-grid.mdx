...
image: /placeholder-assets/images/blog/glow-card-grid.webp
...
<ComponentPreview
 ...
 openInV0Url="https://placeholder.local/r/glow-card-grid-demo.json"
 customizeUrl="https://placeholder.local/preview/glow-card-grid-dialkit"
/>
...
```bash
npx shadcn@latest add @placeholder/glow-card-grid
```
