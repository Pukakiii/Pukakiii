...
image: /placeholder-assets/images/blog/chevrons-up-down-icon.webp
...
<ComponentPreview
 ...
 openInV0Url="https://placeholder.local/r/chevrons-up-down-icon.json"
/>
...
```bash
npx shadcn@latest add @placeholder/chevrons-up-down-icon
```
