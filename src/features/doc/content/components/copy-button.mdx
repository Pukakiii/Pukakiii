...
image: /placeholder-assets/images/blog/copy-button.webp?t=1779078388
...
<ComponentPreview
 ...
 openInV0Url="https://placeholder.local/r/copy-button.json"
/>
...
```bash
npx shadcn@latest add @placeholder/copy-button
```
