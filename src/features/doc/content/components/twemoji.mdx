...
image: /placeholder-assets/images/blog/twemoji.webp
...
<ComponentPreview
  name="twemoji-demo"
  openInV0Url="https://placeholder.local/r/twemoji.json"
/>
...
```bash
npx shadcn@latest add @placeholder/twemoji
```
...
[lib/twemoji-regex.ts](https://github.com/Pukakiii/placeholder.local/blob/main/src/registry/components/twemoji/lib/twemoji-regex.ts)
