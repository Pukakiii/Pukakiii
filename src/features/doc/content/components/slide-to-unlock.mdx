...
image: /placeholder-assets/images/blog/slide-to-unlock.webp
...
<ComponentPreview
  ...
  openInV0Url="https://placeholder.local/r/slide-to-unlock.json"
...
```bash
npx shadcn@latest add @placeholder/slide-to-unlock
```
