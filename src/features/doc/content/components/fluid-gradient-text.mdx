...
image: /placeholder-assets/images/blog/fluid-gradient-text.webp
...
<ComponentPreview
  ...
  openInV0Url="https://placeholder.local/r/fluid-gradient-text.json"
  customizeUrl="https://placeholder.local/preview/fluid-gradient-text-dialkit"
/>
...
```bash
npx shadcn@latest add @placeholder/fluid-gradient-text
```
