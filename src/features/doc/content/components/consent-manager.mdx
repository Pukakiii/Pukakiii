...
image: /placeholder-assets/images/blog/consent-manager.webp
...
<IframeEmbed
 ...
 src="https://react-wheel-picker.placeholder.local/sponsors"
...
```bash
npx shadcn@latest add @placeholder/consent-manager
```
