...
image: /placeholder-assets/images/blog/work-experience-component.webp?t=1779078388
...
<ComponentPreview
  ...
  openInV0Url="https://placeholder.local/r/work-experience.json"
  prose
/>
...
```bash
npx shadcn@latest add @placeholder/work-experience
```
