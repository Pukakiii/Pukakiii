...
image: /placeholder-assets/images/blog/spotlight-logo.webp
new: true
...
<ComponentPreview
  ...
  openInV0Url="https://placeholder.local/r/spotlight-logo.json"
/>
...
```bash
npx shadcn@latest add @placeholder/spotlight-logo
```
