...
image: /placeholder-assets/images/blog/dot-grid-spotlight.webp
...
<ComponentPreview
 ...
 openInV0Url="https://placeholder.local/r/dot-grid-spotlight.json"
/>
...
```bash
npx shadcn@latest add @placeholder/dot-grid-spotlight
```
