...
image: /placeholder-assets/images/blog/scroll-fade-effect.webp
...
<ComponentPreview
  ...
  openInV0Url="https://placeholder.local/r/scroll-fade-effect.json"
/>
...
```bash
npx shadcn@latest add @placeholder/scroll-fade-effect
```
