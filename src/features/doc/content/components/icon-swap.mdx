...
image: /placeholder-assets/images/blog/icon-swap.webp?t=1779078388
...
<ComponentPreview
  name="icon-swap-demo"
  openInV0Url="https://placeholder.local/r/icon-swap.json"
/>
...
```bash
npx shadcn@latest add @placeholder/icon-swap
```
