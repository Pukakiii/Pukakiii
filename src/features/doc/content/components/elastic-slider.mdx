...
image: /placeholder-assets/images/blog/elastic-slider.webp
...
<ComponentPreview
 ...
 openInV0Url="https://placeholder.local/r/elastic-slider.json"
/>
...
```bash
npx shadcn@latest add @placeholder/elastic-slider
```
