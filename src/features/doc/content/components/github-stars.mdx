...
image: /placeholder-assets/images/blog/github-stars.webp?t=1779078388
...
<ComponentPreview
  ...
  openInV0Url="https://placeholder.local/r/github-stars.json"
/>
...
```bash
npx shadcn@latest add @placeholder/github-stars
```
...
```tsx
<GithubStars repo="pukakiii/placeholder.local" stargazersCount={2050} />
```
