...
image: /placeholder-assets/images/blog/toc-minimap.webp?t=1779078388
...
<ComponentPreview
 ...
 openInV0Url="https://placeholder.local/r/toc-minimap.json"
/>
...
```bash
npx shadcn@latest add @placeholder/toc-minimap
```
