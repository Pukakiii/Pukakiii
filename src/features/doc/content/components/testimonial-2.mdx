...
image: /placeholder-assets/images/blog/testimonial-2.webp
new: true
...
<ComponentPreview
  ...
  openInV0Url="https://placeholder.local/r/testimonial-2.json"
/>
...
```bash
npx shadcn@latest add @placeholder/testimonial-2
```
