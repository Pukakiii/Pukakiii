...
image: /placeholder-assets/images/blog/testimonials-marquee.webp?t=1779078388
...
<ComponentPreview
  ...
  openInV0Url="https://placeholder.local/r/testimonials-marquee.json"
/>
...
```bash
npx shadcn@latest add @placeholder/testimonials-marquee
```
