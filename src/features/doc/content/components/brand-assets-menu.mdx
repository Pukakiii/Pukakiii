...
image: /placeholder-assets/images/blog/brand-assets-menu.webp
...
<ComponentPreview
  ...
  openInV0Url="https://placeholder.local/r/brand-assets-menu.json"
/>
...
```bash
npx shadcn@latest add @placeholder/brand-assets-menu
```
