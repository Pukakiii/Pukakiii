...
image: /placeholder-assets/images/blog/middle-truncation.webp
...
<ComponentPreview
  ...
  openInV0Url="https://placeholder.local/r/middle-truncation.json"
/>
...
```bash
npx shadcn@latest add @placeholder/middle-truncation
```
