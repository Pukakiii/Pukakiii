...
image: /placeholder-assets/images/blog/code-block-command.webp?t=1779078388
...
<ComponentPreview
 ...
 openInV0Url="https://placeholder.local/r/code-block-command.json"
/>
...
```bash
npx shadcn@latest add @placeholder/code-block-command
```
...
- [Copy Button](https://placeholder.local/components/copy-button)
