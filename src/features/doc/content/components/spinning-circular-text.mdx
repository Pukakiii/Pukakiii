...
image: /placeholder-assets/images/blog/spinning-circular-text.webp
...
<ComponentPreview
 ...
 openInV0Url="https://placeholder.local/r/spinning-circular-text.json"
/>
...
```bash
npx shadcn@latest add @placeholder/spinning-circular-text
```
...
```tsx
<SpinningCircularText text="Built with care by pukakiii • " />
```
