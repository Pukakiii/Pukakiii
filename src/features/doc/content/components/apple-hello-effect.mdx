...
image: /placeholder-assets/images/blog/writing-effect-inspired-by-apple.webp
...
<ComponentPreview
  ...
  openInV0Url="https://placeholder.local/r/apple-hello-effect.json"
  canReplay
/>
...
```bash
npx shadcn@latest add @placeholder/apple-hello-effect
```

For Hindi:

```bash
npx shadcn@latest add @placeholder/apple-hello-effect-hindi
```

For Spanish:

```bash
npx shadcn@latest add @placeholder/apple-hello-effect-spanish
```

For Vietnamese:

```bash
npx shadcn@latest add @placeholder/apple-hello-effect-vietnamese
```
