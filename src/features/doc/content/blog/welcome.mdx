---
title: Welcome to placeholder.local
description: A pixel-perfect dev portfolio and shadcn registry showcasing my work as a Design Engineer.
image: /placeholder-assets/images/screenshot-og-image-dark.png?t=1778602757
...
Licensed under the [MIT license](https://github.com/Pukakiii/placeholder.local/blob/main/LICENSE). The source code is available on [GitHub](https://github.com/Pukakiii/placeholder.local).
