...
image: /placeholder-assets/images/blog/awesome-terminal.webp
...
Reference: https://github.com/Pukakiii/pukakiii.zsh-theme

```bash
git clone git@github.com:pukakiii/pukakiii.zsh-theme.git ${ZSH_CUSTOM:-~/.oh-my-zsh/custom}/themes/pukakiii.zsh-theme
```

**Activate the theme**

```bash title="~/.zshrc"
ZSH_THEME="pukakiii.zsh-theme/pukakiii"
```
