...
/**
 * Designed by pukakiii on Figma with [Fast Isometric Plugin](https://www.figma.com/community/plugin/1249759048471403961).
 * Inspired by tailwindcss.com.
 */
export function BrandMarkIsometric() {
  const id = useId()
  const ids = {
    facePattern: `pukakiii-face-pattern-${id}`,
    faceFill: `pukakiii-face-fill-${id}`,
    stroke: `pukakiii-stroke-${id}`,
    radialGradient: `pukakiii-radial-gradient-${id}`,
  }
