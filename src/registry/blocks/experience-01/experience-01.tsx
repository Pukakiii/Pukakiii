...
const EXPERIENCE: ExperienceItemType[] = [
  {
    ...
    companyLogo: "/placeholder-assets/images/companies/shadcncraft.svg",
    companyWebsite: "https://placeholder.local?atp=pukakiii",
    positions: [
      {
        id: "1",
  ...
  },
  {
    id: "quaric",
    companyName: "Quaric",
    companyLogo: "/placeholder-assets/images/companies/quaric.svg",
    companyWebsite: "https://placeholder.local",
    positions: [
      {
        id: "2",
        title: "Design Engineer",
...
- Build and maintain placeholder.local with Docusaurus, integrating AdSense.
